def buildServer(){
    withCredentials([
        ...
        // sh 'cd server/'
        sh 'docker build -t anssaeed/my-repo:server1.0  /var/jenkins_home/workspace/online-exam-portal-pipeline/server/'
...
def buildFrontend(){
    withCredentials([
        ...
        // sh 'cd frontend/'
        sh 'docker build -t anssaeed/my-repo:frontend1.0  /var/jenkins_home/workspace/online-exam-portal-pipeline/frontend/'
        sh 'echo $PASS | docker login -u $USER --password-stdin'
